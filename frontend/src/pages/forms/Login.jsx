...
import { login, setRole, setToken } from "../../api/slices/AuthSlice";
import { loginUser } from "../../api/requests/authApi";
...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    await loginUser({ email: emailVal, password: passwordVal })
      .then(({ data }) => {
        ...
        Cookies.set("ACCESS_TOKEN", data.token, { expires: new Date(data.session_expiration),secure:true});
        switch (role) {
          case "user":
            navigate("/");
            break;
          case "admin":
            ...
            break;
          case "superadmin":
            navigate("/superadmin/dashboard/admins-table");
            break;
          default:
            navigate("/");
            break;
    ...
    <div className="min-w-screen min-h-screen flex items-center justify-center px-5 py-5 ">
      <div className="bg-gray-100 rounded-3xl shadow-xl w-full overflow-hidden">
        <div className="md:flex w-full">
          <div className="hidden md:block w-1/2 bg-primary py-6 px-10">
            <svg
          ...
          <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
            ...
            <form onSubmit={handleLogin}>
              ...
              <div className="flex flex-col gap-4 w-full px-3 mb-5">
                <button
                  disabled={loading}
                  type="submit"
                  className={`block w-full max-w-xs mx-auto bg-primary hover:bg-primary focus:bg-primary text-white rounded-lg px-3 py-3 font-semibold ${
                ...
                <a
                  ...
                  className="w-full block max-w-xs mx-auto bg-white hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-lg px-3 py-3 border border-gray-300"
                >
                  <div className="flex items-center justify-center">
                    <img
                      src="https://tailus.io/sources/blocks/social/preview/images/google.svg"
                      className="absoslute left-0 w-5"
                      alt="google logo"
                    />
